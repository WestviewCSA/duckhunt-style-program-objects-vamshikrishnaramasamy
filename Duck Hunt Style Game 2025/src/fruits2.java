...
public class fruits2 {
	...
	// The Duck class represents a picture of a duck that can be drawn on the screen.
	    ...
	    public fruits2() {
	        img = getImage("/imgs/cherries.gif"); // Load the image file
	    ...
	    public fruits2(int x, int y, int scaleX, int scaleY) {
	    	this();
	    	this.x 		= x;
	    	this.y 		= y;
	    	this.scaleX = scaleX;
	    ...
	    //2nd constructor to initialize location and scale!
	    public fruits2(int x, int y, int scaleX, int scaleY, int vx, int vy) {
	    	this();
	    	this.x 		= x;
	    	this.y 		= y;
	    	this.scaleX = scaleX;
